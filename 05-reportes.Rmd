...
Para la construcción del mapa primero obtengamos el archivo [shapefile](https://es.wikipedia.org/wiki/Shapefile), que contiene los elementos geográficos, su geo-localización y su relación con el plano. Haremos uso de la información disponible en [INDEC](https://www.indec.gob.ar/indec/web/Institucional-Indec-Codgeo), al nivel de departamento, que inlcuye datos demográficos del C2010. El paquete *rgdal* nos permitirá integrar los archivos que lo componen y manipularlo.
...
mi_paleta_de_4_grupos <- colorQuantile("YlOrRd", CABA@data$porc_viv_deshab, n = 4)  
