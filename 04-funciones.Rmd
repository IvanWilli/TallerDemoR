...
¿Si quisiera tener opciones al momento de calcular el crecimiento? lineal o exponencial. Incluyamos el argumento `tipo` y utilicemos el condicional **if** para posicionarnos en el modelo que se quiera.
