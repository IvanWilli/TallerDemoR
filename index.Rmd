...
- Encuentra el código fuente de este sitio en [GitHub](https://github.com/IvanWilli/TallerDemoR/blob/master/docs), donde en los archivos *.Rmd* correspondientes a cada unidad estarán los resultados a los ejercicios.
