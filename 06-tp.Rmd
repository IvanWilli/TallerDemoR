...
Realizar un reporte sobre las características demográficas de una provincia argentina seleccionada por el autor, según los resultados del Censo 2022. Los datos los podés encontrar en [la web](https://censo.gob.ar/index.php/datos_definitivos/). Específicamente, se solicita:
