...
author: "Ayelén Martinez, Florecnia Bathory e Iván Williams"
...
2 - **Lectura y manipulación de datos**
  - Mundo [tidyverse](https://www.tidyverse.org/)
  - Un censo en R
...
- Clases
  ...
  - ~30 minutos de resolución en grupos (divido en tandas)
...
- `r fa("question")`: para dudas utilizaremos [issues](https://github.com/IvanWilli/TallerDemoR/issues) de github. Allí podremos plantear dudas con formato de código. Es necesario registrarse.
...
.pull-left[
- Principales tabs:
  - *Source*: donde programo (editor de texto)
  - *Console*: donde se ejecuta el código
  - *Environment*: radar de objetos creados  
  - *Files*: directorio a mano
...
- Conjunto de **funciones** temáticas. 
- *Encapsular* operaciones y relacionarlas.  
...
[Y creciendo día a día](https://rviews.rstudio.com/2021/04/22/march-2021-top-40-new-cran-packages/)
